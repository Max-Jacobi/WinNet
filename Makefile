...
$(BIN_PATH)/$(PROG): version $(OBJ_PATH) $(BIN_PATH) $(OBJS) $(SRCS)
	cd $(OBJ_PATH) && \
...
version:
	@ ((echo "character(80), parameter :: git_tag  = '";git describe --abbrev=0 --tags; echo "'") | tr -d '\n'; echo; \
	   (echo "character(80), parameter :: git_hash = '";git describe --abbrev=10 --always ; echo "'") | tr -d '\n'; echo) > src/version.inc
...
clean:
	rm -rf $(BIN_PATH)/$(PROG) $(OBJS) $(OBJ_PATH)/* src/version.inc
